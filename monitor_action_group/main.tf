resource "azurerm_monitor_action_group" "mag" {
  ...
  short_name          = var.configurations.shortname
  tags                = try(var.configurations.tags, var.tags, {})

  dynamic "arm_role_receiver" {
    for_each = try(var.configurations.arm_role_alert, {})
    content {
  ...
  dynamic "automation_runbook_receiver" {
    for_each = try(var.configurations.automation_runbook_receiver, {})
    content {
  ...
  dynamic "azure_app_push_receiver" {
    for_each = try(var.configurations.azure_app_push_receiver, {})
    content {
  ...
  dynamic "azure_function_receiver" {
    for_each = try(var.configurations.azure_function_receiver, {})
    content {
  ...
  dynamic "email_receiver" {
    for_each = try(var.configurations.email_receiver, {})
    content {
  ...
  dynamic "event_hub_receiver" {
    for_each = try(var.configurations.event_hub_receiver, {})
    content {
  ...
  dynamic "itsm_receiver" {
    for_each = try(var.configurations.itsm_receiver, {})
    content {
  ...
  dynamic "logic_app_receiver" {
    for_each = try(var.configurations.logic_app_receiver, {})
    content {
  ...
  dynamic "sms_receiver" {
    for_each = try(var.configurations.sms_receiver, {})
    content {
  ...
  dynamic "voice_receiver" {
    for_each = try(var.configurations.voice_receiver, {})
    content {
  ...
  dynamic "webhook_receiver" {
    for_each = try(var.configurations.webhook_receiver, {})
    content {
      ...
      dynamic "aad_auth" {
        for_each = try(var.configurations.webhook_receiver.aad_auth, null) == null ? [] : [1]

        content {
          object_id      = var.configurations.webhook_receiver.aad_auth.object_id
          identifier_uri = try(var.configurations.webhook_receiver.aad_auth.identifier_uri, null)
          tenant_id      = try(var.configurations.webhook_receiver.aad_auth.tenant_id, null)
        }
      }
    }
  }
